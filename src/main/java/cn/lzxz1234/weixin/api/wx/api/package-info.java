...
interface WeiXinURL {
    ...
    String POST_TEMP = "http://api.weixin.qq.com/cgi-bin/media/upload?access_token=${accessToken}&type=${type}";
    String GET_TEMP = "http://api.weixin.qq.com/cgi-bin/media/get?access_token=${accessToken}&media_id=${mediaId}";
    
    String ADD_MATERIAL = "https://api.weixin.qq.com/cgi-bin/material/add_material?access_token=${accessToken}&type=${type}";
    String DEL_MATERIAL = "https://api.weixin.qq.com/cgi-bin/material/del_material?access_token=${accessToken}";
    String COUNT_MATERIAL = "https://api.weixin.qq.com/cgi-bin/material/get_materialcount?access_token=${accessToken}";
    String GET_MATERIALS = "https://api.weixin.qq.com/cgi-bin/material/batchget_material?access_token=${accessToken}"; 
