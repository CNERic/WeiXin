package cn.lzxz1234.weixin.api.wx.template;
...
public class PassiveMessage {
    ...
    private static StringTemplate T_TEXT          = StringTemplate.compileFromClassPath("/cn/lzxz1234/weixin/api/wx/template/tpl/passive-text.xml");
    private static StringTemplate T_IMAGE         = StringTemplate.compileFromClassPath("/cn/lzxz1234/weixin/api/wx/template/tpl/passive-image.xml");
    private static StringTemplate T_VOICE         = StringTemplate.compileFromClassPath("/cn/lzxz1234/weixin/api/wx/template/tpl/passive-voice.xml");
    private static StringTemplate T_VIDEO         = StringTemplate.compileFromClassPath("/cn/lzxz1234/weixin/api/wx/template/tpl/passive-video.xml");
    private static StringTemplate T_MUSIC         = StringTemplate.compileFromClassPath("/cn/lzxz1234/weixin/api/wx/template/tpl/passive-music.xml");
    private static StringTemplate T_NEWS          = StringTemplate.compileFromClassPath("/cn/lzxz1234/weixin/api/wx/template/tpl/passive-news.xml");
    private static StringTemplate T_NEWS_Articles = StringTemplate.compileFromClassPath("/cn/lzxz1234/weixin/api/wx/template/tpl/passive-news-article.xml");
