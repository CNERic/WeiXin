...
public class Castors {
    ...
    static {
        ...
        map.put(Long.class, Date.class, new LongToDate());
        map.put(long.class, Date.class, new LongToDate());
    }
    ...
    private static class LongToDate implements Castor<Long, Date> {
        @Override
        public Date cast(Long from, Date defaultValue) {
            return from == null ? defaultValue : new Date(from);
        }
        @Override
        public Long reverse(Date from, Long defaultValue) {
            return from == null ? defaultValue : from.getTime();
        }
    }
    ...
    public interface Castor<F, T> {
        T cast(F from, T defaultValue);
        F reverse(T from, F defaultValue);
    }
